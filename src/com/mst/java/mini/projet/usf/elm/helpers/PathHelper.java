...
public class PathHelper {
    ...
    /// else it return the same format ... because MacOS and Linux distros are both based on UNIX
    ...
    final static String PROJECT_ASSETS_PATH = getProjectLocation()
            +toCurrentOSPathSyntax("/src/com/mst/java/mini/projet/usf/elm"+ toCurrentOSPathSyntax("/assets/"));
}
